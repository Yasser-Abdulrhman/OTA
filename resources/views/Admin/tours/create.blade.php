                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">Add Tour</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.tours.store')}}"
                                              method="POST"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="" id="hot_type"
                                                                   class="form-control"
                                                                   placeholder=""
                                                                   name="tour_address">
                                                            @error("tour_address")
...
{{--                                                    </div>--}}
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="tour_details"  id="details" class="form-control"></textarea>
                                                            @error("tour_details")
                                                            <span class="text-danger font-size-large">{{$message}}</span>
                                                            @enderror
                                                        </div>
