                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.cars')}}">Cars</a>
                                </li>
                                {{--                                <li class="breadcrumb-item active"><a href="{{route('admin.hotels')}}">اللغات</a>--}}
                                {{--                                </li>--}}
                                <li class="breadcrumb-item active"><a href="{{route('admin.cars.create')}}">Add Cars</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <table
                                            ...
                                            @isset($cars)
                                                @foreach($cars as $car)
                                                    <tr>
                                                        <td>{{ $car->car_model}}</td>
                                                        <td><img style="width: 150px; height: 120px" src="../../Images/Cars/{{ $car['car_image']}}"></td>
                                                        <td>{{$car ->car_price}}</td>
