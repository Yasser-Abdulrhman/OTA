        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item  open ">
                <a href=""><i class="la la-home"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">Hotels</span>
                    <span
                        class="badge badge badge-info badge-pill float-right mr-2">21</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.hotels')}}"
                                          data-i18n="nav.dash.ecommerce">Show All Hotels </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.hotels.create')}}" data-i18n="nav.dash.crypto">Add Hotels</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item"><a href="#"><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">Tours</span>
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">21</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item"  href="{{route('admin.tours')}}"
                                          data-i18n="nav.dash.ecommerce">Show All Tours</a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.tours.create')}}" data-i18n="nav.dash.crypto">Add Tours</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">Cars</span>
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">4400</span>
                </a>

                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.cars')}}"
                                          data-i18n="nav.dash.ecommerce">Show All Cars</a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.cars.create')}}" data-i18n="nav.dash.crypto">Add Cars</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">Tour Guide</span>
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">4400</span>
                </a>
...
{{--                    <span--}}
{{--                        class="badge badge badge-success badge-pill float-right mr-2">21</span>--}}
{{--                </a>--}}
{{--                <ul class="menu-content">--}}
